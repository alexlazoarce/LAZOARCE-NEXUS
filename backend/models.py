...
class Employee(db.Model):
    ...
    position = db.Column(db.String(length=100), nullable=True) # Position within our company
    salary = db.Column(db.Float(), nullable=True) # Monthly salary for internal employees
