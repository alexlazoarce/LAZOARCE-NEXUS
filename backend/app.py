...
def create_app(config_object=None, testing_config=None):
    ...
    with app.app_context():
        ...
        try:
            ...
            app.services = {'audit_service': audit_service, 'contract_service': contract_service}
            ...
            Role = User = LoanProduct = LoanApplication = Account = Transaction = JournalEntry = Cliente = ContratoIntegracion = ProductoCredito = Empleado = Planilla = ClientProfile = Tenant = AuditLog = Payment = NotificationTemplate = Employee = ContractTemplate = GeneratedContract = MockModel
            app.services = {'audit_service': lambda: None, 'contract_service': lambda: None}
